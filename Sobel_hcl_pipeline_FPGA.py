...
LBX = s.reuse_at(B, s[sobel.xx], sobel.xx.axis[0], "LBX")
LBY = s.reuse_at(B, s[sobel.yy], sobel.yy.axis[0], "LBY") 
...
hcl_B2 = hcl.asarray(np.random.randint( 10 , size=(height, width))) 
...
f1(hcl_A1, hcl_B1,hcl_Gx1,hcl_Gy2, hcl_m3)
# Return a dictionary storing all the HLS results 
report = f1.report(target)

#imageio.imsave("home_sobel_pipeline.jpg",newimg)                        
